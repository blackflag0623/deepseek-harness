  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Apply Connection\'s Host/Origin checks and browser identity policy to another Web route.',
      ...
      },
      {
        ...
        description: 'Apply the browser identity policy to one frontend index request.',
      ...
      },
      {
        ...
        description: 'Produce the root URL required by the configured browser identity policy.',
